  ...
  return (
    <div className="nav-bar">
      ...
      >
        ...
        {/* <img className='sub-logo' src={logoSubtitle} alt='SaifShariq' /> */}
      </Link>
      ...
      <ul>
        <li>
          <a
            href="https://www.linkedin.com/in/saif-shariq-68ab63a0/"
            target="_blank"
            rel="noreferrer"
          >
        ...
        <li>
          <a
            href="https://github.com/SaifShariq"
            target="_blank"
            rel="noreferrer"
          >
        ...
        <li>
          <a
            href="https://www.youtube.com/@minefeet"
            rel="noreferrer"
            target="_blank"
          >
        ...
        <li>
          <a href="https://twitter.com/SaifShariq_" 
             rel="noreferrer" 
             target="_blank">
